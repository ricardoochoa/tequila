...
5. **Cargar los datos de prueba (Fixtures)**:  
   Para que todos tengamos los mismos escenarios y catálogos de prueba en nuestra base de datos local SQLite, ejecuta:  
   python manage.py loaddata test\_seed.json
