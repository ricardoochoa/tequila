...
def get_default_captured_payload() -> Dict[str, Any]:
    """
    Returns default initial values for captured_payload based on baseline tequila production.
    """
    defaults = {
        "cultivated_area": {"amount": 0.5, "tier1_factor": None},
        "agave_harvested_ton": {"amount": 8.62, "tier1_factor": 0.28},
        "luc_deforestation_ha": {"amount": 0.0, "tier1_factor": None},
        "fertilizer_n_kg": {"amount": 2.5, "tier1_factor": None},
        "fertilizer_p_kg": {"amount": 0.8, "tier1_factor": None},
        "fertilizer_k_kg": {"amount": 0.5, "tier1_factor": None},
        "organic_fertilizer_kg": {"amount": 5.0, "tier1_factor": None},
        "pesticides_active_kg": {"amount": 0.12, "tier1_factor": None},
        "agri_diesel_liters": {"amount": 1.2, "tier1_factor": None},
        "agave_milled_ton": {"amount": 8.62, "tier1_factor": None},
        "agave_transport_km": {"amount": 25.0, "tier1_factor": None},
        "fuel_oil_liters": {"amount": 0.806, "tier1_factor": None},
        "natural_gas_m3": {"amount": 0.0, "tier1_factor": None},
        "lp_gas_liters": {"amount": 0.0, "tier1_factor": None},
        "grid_electricity_kwh": {"amount": 1.20, "tier1_factor": None},
        "solar_electricity_kwh": {"amount": 0.0, "tier1_factor": None},
        "yeast_nutrients_kg": {"amount": 0.0044, "tier1_factor": None},
        "ref_r22_leaked_kg": {"amount": 0.0, "tier1_factor": None},
        "ref_r134a_leaked_kg": {"amount": 0.0, "tier1_factor": None},
        "glass_bottles_kg": {"amount": 0.55, "tier1_factor": None},
        "cardboard_boxes_kg": {"amount": 0.12, "tier1_factor": None},
        "groundwater_m3": {"amount": 0.00716, "tier1_factor": 0.65},
        ...
        "vinasse_volume_m3": {"amount": 0.012, "tier1_factor": None},
        "vinasse_cod_mg_l": {"amount": 50000.0, "tier1_factor": None},
        "vinasse_treatment": {"amount": "pit", "tier1_factor": None},
        "bagasse_generated_ton": {"amount": 0.00142, "tier1_factor": None},
        ...
        "solid_waste_recycled_t": {"amount": 0.0005, "tier1_factor": None},
    }
    return defaults
